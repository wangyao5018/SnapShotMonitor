package com.wyjson.snapshotmonitor.costom;
...
public class PaintableImageView extends ImageView {
    ...
    private LineType currentLineType = LineType.NormalLine; // 当前线条类型
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (LineInfo lineinfo : lineList) {
            if (lineinfo.getLineType() == LineType.NormalLine) {
                drawNormalLine(canvas, lineinfo);
            } else if (lineinfo.getLineType() == LineType.MosaicLine) {
